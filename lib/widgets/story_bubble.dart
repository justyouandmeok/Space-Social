    ...
    return GestureDetector(
      ...
      child: SizedBox(
        ...
        child: Column(children: [
          ...
          Text(mine ? 'Tu historia' : user.username, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 11.5, height: 1.15, color: SpaceColors.text, fontWeight: FontWeight.w400)),
        ]),
      ),
    );
  }
